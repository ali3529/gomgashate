...
//            }
//        }));
        String s="ای گمگشته دلها به جهان بازآی، ای منتقم خون خدا بازآی ، با این همه جرم و گنه باز منتظریم ، چون (لاتقنطو من رحمه الله) بازآی\n" +
                "\n" +
                "شرکت همیاران گمگشته دلها 780 در سال 1399 با شماره ثبت 53871 با عنایات الطاف الهی و استمداد از قطب عالم امکان حضرت ولی عصر (عج) برای رفاه حال هموطنان عزیز ایران اسلامی جهت پیدا کردن گمشده های خود بوجود آمده که تاثیر به سزائی در هزینه، وقت و جلوگیری از اسراف در امور مردم و دولت عزیز می باشد که نیازمند همکاری شما هموطنان عزیز در این امر خیرخواهانه هستیم.          الحمدلله به لطف خدا وتوجه خاصه امام عصر(عج) درمیلادسرارنورکوثرآل طه حضرت صدیقه اطهر فاطمه الزهرا(سلام الله علیها)به تاریخ14/11/99شمسی بیست جمادی الثانی1442 این طرح خیرخواهانه شروع به فعالیت خودنمود\n" +
                "\n" +
                " \n" +
                "\n" +
